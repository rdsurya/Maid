...
$sqlComplete="Select customer_id, customer_name, count(booking_date) as total from booking where status='0' group by customer_id order by total desc limit 10;";
