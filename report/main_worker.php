                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <ol class="breadcrumb">
                                ...
                                <li class="active">
                                    <i class="fa fa-file"></i> Worker Report
                                </li>
                            </ol>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="panel panel-primary" id="d_complete">
                            <div class="panel-heading" style="font-size: 20px;">
                                Top 10 workers with highest completed booking
                            </div>
                    ...
                    <div class="row">
                        <div class="panel panel-green" id="d_new">
                            <div class="panel-heading" style="font-size: 20px;">
                                Top 10 workers with highest new booking
                            </div>
                            <div class="panel-body">
                                <div class="chart-container" style="height: 100%; min-height: 550px; width: 100%; min-width: 550px; max-height: 800px;">
                    ...
                    <hr/>
                    <div class="row">
                        <div class="panel panel-yellow" id="d_hour">
                            <div class="panel-heading" style="font-size: 20px;">
                                Top 10 workers with highest working duration
                            </div>
                            <div class="panel-body">
                                <div class="chart-container" style="height: 100%; min-height: 550px; width: 100%; min-width: 550px; max-height: 800px;">
                                    <canvas id="hour_canvas" style="height: 500px;"></canvas>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="panel panel-red" id="d_cancel">
                            <div class="panel-heading" style="font-size: 20px;">
                                Top 10 workers with highest canceled booking
                            </div>
                            <div class="panel-body">
                                <div class="chart-container" style="height: 100%; min-height: 550px; width: 100%; min-width: 550px; max-height: 800px;">
...
<!--        <script type="text/javascript" src="../assets/js/jquery.datetimepicker.full.min.js"></script>
        ...
        <script type="text/javascript">
            ...
            function getSummary() {
                $.ajax({
                    type: 'POST',
                    url: "./worker_control/getSummary.php",
                    dataType: 'json',
                    timeout: 6000,
                    success: function (data, textStatus, jqXHR) {
                        $('#s_complete').html(data.complete);
                        $('#s_new').html(data.new);
                        $('#s_hour').html(data.hours);
...
//                var canvas = $('#complete_canvas');
            ...
            function getWorkerDataComplete() {
                $.ajax({
                    ...
                    dataType: 'json',
                    success: function (data, textStatus, jqXHR) {
                        createGraph(data, "Top 10 worker", $('#complete_canvas'), "Completed Booking");
                    },
                    error: function (jqXHR, textStatus, errorThrown) {
            ...
            function getWorkerDataNew() {
                $.ajax({
                    ...
                    dataType: 'json',
                    success: function (data, textStatus, jqXHR) {
                        createGraph(data, "Top 10 worker", $('#new_canvas'), "New Booking");
                    },
                    error: function (jqXHR, textStatus, errorThrown) {
                        alert("Oops! Problem loading graph. " + errorThrown);
                    }
            ...
            function getWorkerDataHour() {
                $.ajax({
                    ...
                    dataType: 'json',
                    success: function (data, textStatus, jqXHR) {
                        createGraph(data, "Top 10 worker", $('#hour_canvas'), "Duration in hours");
                    },
                    error: function (jqXHR, textStatus, errorThrown) {
                        alert("Oops! Problem loading graph. " + errorThrown);
                    }
            ...
            function getWorkerDataCancel() {
                $.ajax({
                    ...
                    dataType: 'json',
                    success: function (data, textStatus, jqXHR) {
                        createGraph(data, "Top 10 worker", $('#cancel_canvas'), "Canceled Booking");
                    },
                    error: function (jqXHR, textStatus, errorThrown) {
                        alert("Oops! Problem loading graph. " + errorThrown);
                    }
